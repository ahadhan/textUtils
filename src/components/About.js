...
export default function About() {
    ...
    return (
        <>
            <div className="accordion accordion-flush container my-4 width-80vw" style={myStyle} id="accordionFlushExample">
            ...
            <div className="container">
                <button type="button my-3" class="btn btn-dark" style={btnColor} onClick={switchColor}>{btnText}</button>
            </div>
        </>
    )
};